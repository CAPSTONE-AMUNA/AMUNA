...
public class imageUpload extends AppCompatActivity {
    ...
    public Button   selectImage,
            next;
    public String SERVER = "http://matehunter.cafe24.com/upload.php?Email="+MyEmail,
            timestamp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(imageUpload.this, SuccessRegisterActivity.class);
    ...
    private class Upload extends AsyncTask<Void,Void,String>{
        ...
        protected String doInBackground(Void... params) {
            ...
            try{
                ...
                String response = imageRequest.post(SERVER,dataToSend);
