        ...
        switch (v.getId()) {
            ...
            case R.id.authBtn:
                ...
                Thread mThread = new Thread() {
                    ...
                    public void run() {
                        try {
                            URL url = new URL("http://matehunter.cafe24.com/emailcheck.php?Email="+authEmail.getText().toString());
                ...
                if(Check.equals("0")) {
                    try {
                        ...
                        gMailSender.sendMail("[AMUNA] 가입 인증 메일입니다.", "인증번호: " + randomNum, authEmail.getText().toString());
