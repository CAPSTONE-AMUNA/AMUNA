...
public class LifeCharTestRequest extends StringRequest {
    final static private String URL = "http://matehunter.cafe24.com/LifeCharTest.php";
    private Map<String, String> parameters;

    public LifeCharTestRequest(String Email, int My_q1, int My_q2, int My_q3, int My_q4, int My_q5, int My_q6, int My_q7, int My_q8, int My_q9,
